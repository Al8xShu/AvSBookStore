...
{
    public class AvSBookStoreDbContext : DbContext
    {
        ...
        public AvSBookStoreDbContext(DbContextOptions<AvSBookStoreDbContext> options)
            : base(options)
        { }
            ...
            modelBuilder.Entity<BookDto>(action =>
            {
                ...
                action.HasData(
                    new BookDto
                    {
                        ...
                        Description = "This volume begins with basic programming concepts and techniques," +
                    ...
                    new BookDto
                    {
                        ...
                        Author = "M. Fowler",
                        Title = "Refactoring",
                        Description = "As the application of object technology--particularly the Java programming" +
                        " language--has become commonplace, a new problem has emerged to confront the software" +
                    ...
                    new BookDto
                    {
                        ...
                        Description = "Known as the bible of C, this classic bestseller introduces the C " +
                        "programming language and illustrates algorithms, data structures, and programming" +
                        " techniques.",
                        Price = 14.98m,
                    }
                );
