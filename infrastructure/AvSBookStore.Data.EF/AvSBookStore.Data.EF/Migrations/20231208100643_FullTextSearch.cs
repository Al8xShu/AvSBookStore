...
namespace AvSBookStore.Data.EF.Migrations
{
    public partial class FullTextSearch : Migration
    {
        ...
        {
            migrationBuilder.Sql("CREATE FULLTEXT CATALOG AvSBookStoreFullTextCatalog AS DEFAULT", suppressTransaction: true);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP FULLTEXT CATALOG AvSBookStoreFullTextCatalog", suppressTransaction: true);
        }
    }
}
